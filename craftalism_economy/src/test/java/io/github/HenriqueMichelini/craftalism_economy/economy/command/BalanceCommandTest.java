...
class BalanceCommandTest {
    ...
    void setUp() {
        ...
        balanceCommand = new BalanceCommand(balanceManager, plugin, currencyFormatter, playerValidator);
    }
    ...
    class ConstructorTests {
        ...
        void constructor_ValidDependencies_CreatesInstance() {
            // When & Then
            assertDoesNotThrow(() ->
                    new BalanceCommand(balanceManager, plugin, currencyFormatter, playerValidator));
        }
        ...
        void constructor_NullBalanceManager_ThrowsException() {
            ...
            IllegalArgumentException exception = assertThrows(
                    ...
                    () -> new BalanceCommand(null, plugin, currencyFormatter, playerValidator)
            );
        ...
        void constructor_NullPlugin_ThrowsException() {
            ...
            IllegalArgumentException exception = assertThrows(
                    IllegalArgumentException.class,
                    () -> new BalanceCommand(balanceManager, null, currencyFormatter, playerValidator)
            );
        ...
        void constructor_NullCurrencyFormatter_ThrowsException() {
            ...
            IllegalArgumentException exception = assertThrows(
                    IllegalArgumentException.class,
                    () -> new BalanceCommand(balanceManager, plugin, null, playerValidator)
            );
        ...
        void constructor_NullPlayerValidator_ThrowsException() {
            ...
            IllegalArgumentException exception = assertThrows(
                    IllegalArgumentException.class,
                    () -> new BalanceCommand(balanceManager, plugin, currencyFormatter, null)
            );
        ...
        void legacyConstructor_CreatesInstanceWithDefaultValidator() {
            // When & Then
            assertDoesNotThrow(() ->
                    new BalanceCommand(balanceManager, plugin, currencyFormatter));
        }
    }
