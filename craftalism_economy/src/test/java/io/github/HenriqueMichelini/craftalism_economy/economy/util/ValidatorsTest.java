...
class ValidatorsTest {
    ...
    void setUp() {
        ...
        validators = new Validators(balanceManager);
    ...
    class InputValidationTests {
        ...
        void resolvePlayer_InvalidInput_ReturnsEmpty(String input) {
            // When
            Optional<OfflinePlayer> result = validators.resolvePlayer(requester, input);
        ...
        void resolvePlayer_UnicodeUsername_HandledCorrectly() {
            ...
            // When
            Optional<OfflinePlayer> result = validators.resolvePlayer(requester, unicodeUsername);
        ...
        void resolvePlayer_VeryLongUsername_HandledCorrectly() {
            ...
            // When
            Optional<OfflinePlayer> result = validators.resolvePlayer(requester, longUsername);
    ...
    class OnlinePlayerTests {
        ...
        void resolvePlayer_OnlinePlayer_ReturnsPlayer() {
            ...
            // When
            Optional<OfflinePlayer> result = validators.resolvePlayer(requester, ONLINE_PLAYER_NAME);
        ...
        void resolvePlayer_ExactNameMatch_ReturnsCorrectPlayer() {
            ...
            // When
            Optional<OfflinePlayer> result = validators.resolvePlayer(requester, "TestPlayer");
        ...
        void resolvePlayer_OnlinePlayerTakesPrecedence_ReturnsOnlinePlayer() {
            ...
            // When
            Optional<OfflinePlayer> result = validators.resolvePlayer(requester, playerName);
    ...
    class OfflinePlayerTests {
        ...
        void resolvePlayer_OfflinePlayerExists_ReturnsOfflinePlayer() {
            ...
            // When
            Optional<OfflinePlayer> result = validators.resolvePlayer(requester, OFFLINE_PLAYER_NAME);
        ...
        void resolvePlayer_UUIDVersionCheck_WorksCorrectly() {
            ...
            // When
            Optional<OfflinePlayer> result = validators.resolvePlayer(requester, "RealPlayer");
            ...
            Optional<OfflinePlayer> fakeResult = validators.resolvePlayer(requester, fakePlayerName);
    ...
    class EdgeCaseTests {
        ...
        void resolvePlayer_PlayerDoesNotExist_ReturnsEmpty() {
            ...
            // When
            Optional<OfflinePlayer> result = validators.resolvePlayer(requester, nonExistentPlayer);
